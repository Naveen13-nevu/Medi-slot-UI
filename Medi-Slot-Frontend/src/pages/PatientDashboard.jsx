        ...
        <DialogContent>
          {bookedSlotInfo && (
            <Box>
              ...
              <Typography variant="body1" gutterBottom>
                <strong>Date:</strong>{' '}
                {new Date(bookedSlotInfo.startTime).toLocaleDateString('en-US', { weekday: 'long', year: 'numeric', month: 'long', day: 'numeric' })}
              </Typography>
              <Typography variant="body1" gutterBottom>
                <strong>Time:</strong>{' '}
